...
Зачем вообще мы заботимся об связываниях внутри наших единиц трансляции? Одна из причин - `ODR`


Описать в каждой главе различные комбинации ключевых слов и их влияния на связыванеи 
