...
Казалось бы, есть внутреннее и внешнее, что значит "нет связывания". По сути то и значит, объект не принадлежит ни одной единице трансляции. По сути это означает, что имя сущности известно исключительно в рамках того блока кода, где оно объявлено. Оно не принадлежит единице трансляции в целом и тем более не может быть экспортировано наружу.
