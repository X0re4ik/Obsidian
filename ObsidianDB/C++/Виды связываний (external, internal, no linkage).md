...
Вспомним пример из главы "Сила в его слабости", а что если и правда 2 разработчика напишут идентичные классы с идентичными методами, отдебажить подобную ошибку будет невероятно трудно, хотя и реально (в том может помочь карта ссылок, которую можно получить флагом ``)
