...
Естественно, любая подобная тема по `C++` не могла обойтись без примера шаблонного метода или функции, но на самом деле мы уже дали ответ в предыдущей главе, вспомним, что

>все *определения* внутри класса получают неявный `inline`
