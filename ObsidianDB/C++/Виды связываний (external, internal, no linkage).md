...
Казалось бы, есть внутреннее и внешнее, что значит "нет связывания". По сути это означает, что имя сущности известно исключительно в рамках того блока кода, где оно объявлено, линковщику эта переменная просто неинтересна, так как он не может ее переис
