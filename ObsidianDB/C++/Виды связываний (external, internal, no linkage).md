...
Ранее мы упомнялу, что таблица символов, может возвращать тип связывания `weak`, который тоже внешний, но почему-то именуется слабым, чтобы раскрыть это поможет нам `inline`
...
0000000000000000  w    F .text._Z3foov  000000000000000f foo()
0000000000000000 g     F .text  0000000000000010 foo1()
```



И вот она точка - вроде бы все понятно... Но....
