...
Ранее мы говорили, что таблица символов, может возвращать тип связывания `weak`, который тоже внешний, но почему-то именуется слабым. У слабого свзывания есть неоспоримое преимущество и недостаток - преимущество в том, что линковщик выберет только 1 реализацию и именно ей будут пользоваться все остальные, но если по какой либо причине реализации отличаются - UB
