...
Обратим внимание на значения из второй колонки -  `g` (`global`) и `l` (`local`) именно эти параметры и область видимости, в данном объектном файле функция `sqr` имеет глобальную область видимсоти, а значит будет доступна и
