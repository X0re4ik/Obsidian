...
Казалось бы, есть внутреннее и внешнее, что значит "нет связывания". По сути то и значит, объект не принадлежит ни одной единице трансляции. Но как это возможно, ведь люб 
