...
Мы видим, что по умолчанию `foo` была `external` и имела слабую связанность, но аннонимность позволила превратить `foo` в `internal`, что позволило избежать `ODR`, а так же позволило нашей программе наконец-то твердо и чётко заявить о своем отношении к оливкам
