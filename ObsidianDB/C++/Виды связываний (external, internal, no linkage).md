...
Казалось бы, есть внутреннее и внешнее, что значит "нет связывания". По сути то и значит, объект не принадлежит ни одной единице трансляции. Но как это возможно, ведь любая переменная не может появится из неоткуда, есть конкретный файл 
