...
KISS - принц, который говорит нам быть "попроще", ООП это все хорошо, но код нужен только для того, чтобы решить бизнес задачу, если ее можно решить быстро и эффективно 
