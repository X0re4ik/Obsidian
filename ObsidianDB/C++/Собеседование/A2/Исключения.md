...
Каждая функция при генерации компилятором имеет так называемый `landing pads` - специальный раздел, который говорит, есть ли в данной функции обработка исключения или же при ошибке необходимо выполнить полный cleanup 
