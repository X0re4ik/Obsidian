...
Теперь мы немножко больше знаем о том, какова природа `ODR`, как наши объектные файлы видят соседи по компановке и как различные спецификаторы раскрывают и закрывают доступ извне к переменным и функциям.

Спасибо большое за просмотр этой скромной статьи, буду рад комментариям под постом 🙌